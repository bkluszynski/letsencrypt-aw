...
#      UPDATE 2022-24-01 (by Benjamin Bülow)
#      - Add Multiple Domain functionality.
#      - Script is now able to process Multiple Domains. Just Provide Domais comma seperated ;).
#        
#
#######################################################################################
...
#alle Domains als String array, da in das Feld auch Multiple Domains mit Komma separiert eingegeben werden können
